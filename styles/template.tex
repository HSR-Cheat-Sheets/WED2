\documentclass[a4paper, landscape , 7pt]{scrartcl}
...
\titleformat{name=\subsubsection}[block]{\sffamily\footnotesize}{}{0pt}{\colorsubsubsection}
...
%{\normalfont\bfseries}{\theparagraph}{1em}{\vspace{-10pt}\color{black}\ #1 \vspace{-8pt}}
